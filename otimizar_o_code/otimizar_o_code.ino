...
int cont = 0, cont1 = 0, cont2 = 0, n = 0;
  ...
  else if (pro == 1)
  {
    if (turma == '1')
    {
      ...
      if (conteudo.substring(1) == "82 30 53 73" or conteudo.substring(1) == "51 84 CE 94" or conteudo.substring(1) == "7D 84 51 6F")
      {
        ...
        {
          String nome = "Giselly Avelino Perereira";
          if (cont1 < 1)
          {
            lcd.setBacklight(HIGH);
            lcd.setCursor(0, 0);
...
void neg() {
  ...
  Serial.print("Carṭo ṇo cadastrado");
  Serial.println();
  printLcd("  Cartao nao    ", "    cadastrado    ", 0);
  reed();
}


void cadastro (String nome, int n)
{
