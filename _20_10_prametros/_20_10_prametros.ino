    ...
    if (conteudo.substring(1) == "82 30 53 73" or conteudo.substring(1) == "51 84 CE 94" or conteudo.substring(1) == "7D 84 51 6F") {
      if (conteudo.substring(1) == "82 30 53 73"){
        ...
        if (cont == 0) {
          ...
          matricula("Billyfranklim Avelino Pereira");
          cont++;
        }
        else {
          saida("Billyfranklim Avelino Pereira");
          cont = 0;
        ...
        if (cont == 0) {
          ...
          matricula("Giselly Pereira Oliveira");
          cont++;
        }
        else {
          saida("Giselly Pereira Oliveira");
          cont = 0;
          ...
          matricula("Franklim Oliverira Silva");
          cont++;
        }
        else {
          saida("Franklim Oliverira Silva");
          cont = 0;
